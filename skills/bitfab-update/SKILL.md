...
1. If the plugin was updated, remind the user to restart Cursor to apply the update. If the mode was `plugin`, stop here — do not run the 1-7 steps of the SDK phase.
