        ...
        for (const step of phase.steps) {
            ...
            if (step.kind === "action" ||
                ...
                for (const branch of step.branches) {
                    ...
                    const label = branch.recommended
                        ? `${baseLabel} (recommended)`
                        : baseLabel;
                    lines.push(`  ${nodeId(src)} -->|${escapeMermaidLabel(label)}| ${target}`);
                }
            }
