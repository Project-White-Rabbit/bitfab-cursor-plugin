...
(\`{{pluginRoot}}\` resolves to the plugin directory; \`<planId>\` is the id parsed from step {{step:view/fetch-plan}}.) The script navigates Studio to the trace plan page and **blocks** until the user closes Studio or clicks Confirm/Cancel{{#codex}} (up to 30 minutes){{/codex}}. View is read-only; whichever button the user clicks, do **not** apply edits or call {{tool:getTracePlan}} again. When the process exits, report that the plan was viewed and stop.{{#codex}}
