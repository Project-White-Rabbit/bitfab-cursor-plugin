...
export const setupFlow = Flow.parse({
    ...
    commands: {
        ...
        login: {
            file: "login.js",
            description: "Authenticate via browser OAuth (blocks until complete)",
        },
        openTracePlan: {
...
| \`{{cmd}}setup login\` | Authenticate via browser OAuth and retrieve API key |
