...
| \`{{cmd}}setup analyze-repo [limit=<n>]\` | Non-interactively scan the repo, pick the top workflows to trace (default 5, or \`limit=<n>\`), and upload a draft trace plan for each (no prompts, no code changes) |`,
    entries: {
