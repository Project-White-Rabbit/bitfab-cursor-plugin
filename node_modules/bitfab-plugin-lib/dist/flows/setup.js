...
- Live in a \`scripts/\` directory (or the project's existing scripts location)`,
                ...
                },
                {
                    ...
                    body: `**Safety net for legacy instrumentation.** If an already-instrumented function (introduced before Instrument's trace-boundary serializability gate, or via another path) can't be invoked from the replay script, most commonly because it isn't exported, is defined inline in a route handler, or takes unserializable inputs, {{askVerb}} offering Instrument's trace-boundary resolutions:
            ...
            steps: [
                {
                    ...
                    body: `**Confirm the SDK language.** DB-branching replay is available for **TypeScript, Python, and Ruby**. If the project is **Go**, tell the user Go has no replay so this doesn't apply, and route to cleanup.
