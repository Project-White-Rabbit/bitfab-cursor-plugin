...
- **Subtree capture**: ✅ wired / ⚠️ \`@bitfab/transform\` installed but no adapter in the real build path / ❌ \`@bitfab/transform\` missing / ❌ Python below 3.12 / \`n/a (no opt-out roots)\` (from the subtree-capture check in step {{step:inspect/check-freshness}}).
