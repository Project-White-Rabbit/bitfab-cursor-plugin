...
- If a command exits quickly with a completion or error JSONL line, handle it immediately. If it remains running after the needed handshake, leave it in the background and move on.{{/codex}}`,
    ...
    modeHints: {
        ...
        replay: "`<key> <trace-id>`. Minimal single-trace replay, entirely in-chat: run the replay script against one trace and report pass/fail in one line. No Studio, dataset, labeling, or server-side persistence. For verifying a fix you already made.",
