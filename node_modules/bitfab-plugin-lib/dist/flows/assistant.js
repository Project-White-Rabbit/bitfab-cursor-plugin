...
\`\`\`bash
{{command:openStudio}} <path> [agentSessionId]
\`\`\`
...
{{whens}}`,
                ...
                },
                {
                    ...
                    toolCalls: ["bash", "grep", "ask", "skill"],
                    title: "Detect replay script capabilities",
                    body: `**Detect replay script capabilities.** Check what the replay script supports. These flags determine how experiment results are tracked and displayed. **If you already ran this step in Phase 2 earlier in this session, skip it and continue to \`make-change\`.**
