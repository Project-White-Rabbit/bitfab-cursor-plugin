...
{{branches}}`,
                ...
                },
                {
                    ...
                    body: `**Upgrade the SDK and replay script.** The replay script references SDK APIs (\`experimentGroupId\`, \`codeChangeDescription\`, per-item \`traceId\`) that require a recent SDK. Upgrade the SDK first, then regenerate the script.
...
{{whens}}`,
                ...
                },
                {
                    ...
                    body: `Open the dataset review page for the user **immediately** after picking or creating the dataset. Use \`openStudioTo.js\` to route Studio to the dataset review page:
...
{{whens}}`,
                    branches: [
                        ...
                        {
                            when: "every item errored (completed is 0 but total is non-zero)",
                            description: `systemic infra failure (usually env mismatch). Diagnose, confirm a script fix with the user, loop back`,
                            next: "phase-5/replay-against-dataset",
                        },
                        {
                            when: "high infra error rate (over half of items errored)",
