...
If the user chooses **"Instrument now"**, invoke \`{{cmd}}setup instrument\`{{#claude}} using the Skill tool{{/claude}}, then verify whether a replay script exists for this function. If **"Continue anyway"**, skip the replay-script check and start building the dataset, there's no local code to iterate on yet. If **"Stop"**, navigate to \`/studio/close\` via \`navigateStudio.js\` to gracefully close the Studio, kill the background process, then stop.`,
                    branches: [
                        {
...
If the user chooses **"Create replay now"**, invoke \`{{cmd}}setup replay\`{{#claude}} using the Skill tool{{/claude}}, then start building the dataset. If **"Stop"**, navigate to \`/studio/close\` via \`navigateStudio.js\` to gracefully close the Studio, kill the background process, then stop.`,
                    branches: [
                        {
                    ...
                    branches: [
                        {
                            ...
                            description: `tell the user the function has no usable dataset yet and recommend running \`{{cmd}}assistant dataset <key>\` first; navigate to \`/studio/close\` via \`navigateStudio.js\` to gracefully close the Studio, kill the background process, then stop the flow`,
                            next: null,
                        },
                        {
