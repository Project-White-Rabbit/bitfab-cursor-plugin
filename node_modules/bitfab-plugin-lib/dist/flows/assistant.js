...
export const assistantFlow = Flow.parse({
    ...
    emitTemplate: '**Studio activity:** If `studioMode` is true, run `node "{{pluginRoot}}/dist/commands/pushActivity.js" {action} "{displayName}"`.',
    tools: {
...
\`\`\`bash
node "{{pluginRoot}}/dist/commands/openStudioTo.js" <path> [agentSessionId]
\`\`\`
...
\`\`\`bash
node "{{pluginRoot}}/dist/commands/openStudioTo.js" "/studio/trace-functions/<functionKey>/datasets/<datasetId>"
\`\`\`
...
\`\`\`bash
node "{{pluginRoot}}/dist/commands/openStudioTo.js" "/studio/experiments?experimentGroupId=<experimentGroupId>"
\`\`\`
...
\`\`\`bash
node "{{pluginRoot}}/dist/commands/openStudioTo.js" "/studio/experiments?testRunIds=<testRunId1>,<testRunId2>,<testRunId3>"
\`\`\`
