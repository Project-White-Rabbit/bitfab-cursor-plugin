...
|---|---|---|
| \`wizard\` | \`{{cmd}}assistant\`, \`{{cmd}}assistant wizard [<key>]\`, or \`{{cmd}}assistant <key>\` | Full flow: pick function → verify instrumentation → pick or create dataset → label → diagnose → iterate → wrap up |
