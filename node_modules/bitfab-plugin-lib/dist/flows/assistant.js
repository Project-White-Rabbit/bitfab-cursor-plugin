...
{{whens}}`,
                ...
                },
                {
                    ...
                    body: `**Open experiment viewer.** This step only runs when replay trace IDs are available (routed here from \`check-trace-id-support\`). If no \`testRunId\`s were captured, skip this step and continue to evaluate.
