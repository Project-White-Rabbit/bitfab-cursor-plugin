...
{{whens}}`,
                    branches: [
                        ...
                        },
                        {
                            ...
                            description: `proceed. Carry \`infraErrored\` forward, surface as its own **unreplayable** bucket in the final report (the share-results step, or the benchmark scorecard's Unreplayable row in \`benchmark\` mode), never folded into pass/fail`,
                            next: "iterate/check-verdict-persistence",
                        },
                    ],
                },
