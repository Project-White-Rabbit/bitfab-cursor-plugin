...
- When the process exits, immediately continue with the next step in the flow, do not wait for another user message.{{/codex}}`,
    entries: {
        wizard: {
            default: "studio/open",
...
3. **Attach the trace** with {{tool:addTracesToDataset}} (\`datasetId\`, \`[traceId]\`; idempotent). **Report the tool's actual added/skipped counts**, do not claim "saved" if it skipped the trace.
