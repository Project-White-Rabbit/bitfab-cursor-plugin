...
export async function collectSessionStartMessages(currentVersion, platform, pluginRoot, scriptUrl) {
    const messages = [];
...
export async function runSessionStart(currentVersion, platform, pluginRoot, scriptUrl, sessionId) {
    const messages = await collectSessionStartMessages(currentVersion, platform, pluginRoot, scriptUrl);
    const contextParts = [];
    if (sessionId) {
