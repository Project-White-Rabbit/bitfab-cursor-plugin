...
export function createMcpServer(platform, getConfig, pluginVersion) {
    ...
    server.registerTool("get_experiment_traces", {
        description: "Get individual trace results for an experiment (test run), including each replay trace's verdict (fixed, regressed, still-passing, still-failing, unpaired) by comparing against the original trace's label. Use after list_experiments to drill into a specific experiment's results.",
        inputSchema: {
            testRunId: z
                .uuid()
