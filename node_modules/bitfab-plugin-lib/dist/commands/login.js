    ...
    try {
        ...
        const result = await openStudioTo("/studio", {
            ...
            emit: (event) => {
                ...
                const url = event.event === "window-open-requested"
                    ? event.url
                    : event.event === "auth-required"
                        ? event.signInUrl
                        : null;
                if (url && !printedSignInUrl) {
                    printedSignInUrl = true;
