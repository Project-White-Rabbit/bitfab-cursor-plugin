...
// comments, and had drifted on read_span_field.maxChars.
//
...
// read_grader_labels returns one line per (trace, grader) verdict, so its
// payload scales with graders-per-trace rather than span size.
const READ_GRADER_LABELS_MAX_IDS = 100;
...
// client and a direct HTTP caller are coerced identically. read_span_field's
...
export const updateAgentLabels = {
...
export const addGraderToExperimentGroup = {
...
export const getExperimentTraces = {
...
export const readGraderLabels = {
    ...
    inputSchema: {
        traceIds: z
            .preprocess(parseJsonString, z.array(z.uuid()).min(1).max(READ_GRADER_LABELS_MAX_IDS))
            .optional()
            .describe(`Trace IDs to read grader verdicts for (1-${READ_GRADER_LABELS_MAX_IDS}). Omit to read by grader instead.`),
        graderId: z
            .uuid()
            .optional()
