...
export const getLabelEvidence = {
    ...
    inputSchema: {
        traceId: z.uuid().describe("The trace whose spans could provide evidence"),
        assertionId: z
            .uuid()
            .optional()
            .describe("The assertion the potential evidence would support. Omit it for the whole-trace label."),
    },
};
