...
export const archiveTraceAssertions = {
    ...
    inputSchema: {
        traceId: z
            .uuid()
            .describe("The trace the expectations are attached to. This is the ORIGINAL trace they were written on, not a replay that inherited them."),
        assertionIds: z
            .preprocess(parseJsonString, z.array(z.uuid()).min(1).max(MAX_ASSERTIONS_PER_REQUEST))
            .describe(`Ids of the expectations to archive (1-${MAX_ASSERTIONS_PER_REQUEST}), from get_trace_assertions`),
    },
};
