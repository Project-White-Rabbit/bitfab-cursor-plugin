...
packages:
  ...
  zod@4.6.4:
    resolution: {integrity: sha512-AXSD6hvGdvRjajG/l1cC+d6IrhH+sjmPKtYeQdJIK8MFJl3LyClzS+o/YsVC+zQZPupAaeH5skwwm8YqYH7BqA==}
...
snapshots:
  ...
  '@modelcontextprotocol/sdk@1.30.0(zod@4.6.4)':
    dependencies:
      '@hono/node-server': 2.1.1(hono@4.13.7)
      ajv: 8.20.0
      ...
      raw-body: 3.0.2
      zod: 4.6.4
      zod-to-json-schema: 3.25.2(zod@4.6.4)
