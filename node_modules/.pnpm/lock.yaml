...
packages:
  ...
  zod@4.5.3:
    resolution: {integrity: sha512-DVADDs2rc+nEbqt+Lsd1ESk6FokySOACfLuon6MNrLnFfE4EBdgb3DcXrnHmngIZBBdPz2PJMPBtgzaMIk59ZA==}
...
snapshots:
  ...
  '@modelcontextprotocol/sdk@1.30.0(zod@4.5.3)':
    dependencies:
      '@hono/node-server': 2.1.1(hono@4.13.5)
      ajv: 8.20.0
      ...
      raw-body: 3.0.2
      zod: 4.5.3
      zod-to-json-schema: 3.25.2(zod@4.5.3)
