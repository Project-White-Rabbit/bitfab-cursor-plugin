...
function renderModePreface(ctx, phase, reachableSteps) {
    ...
    const modeList = ctx.allModes
        ...
        .map((m) => `\`${m}\``)
        .join(" or ");
    return `**Mode:** you were dispatched with a mode (${modeList}); the gates and Next routing below depend on it.`;
}
/**
