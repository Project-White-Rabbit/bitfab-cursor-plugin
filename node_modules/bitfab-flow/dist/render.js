 ...
 *
 * Phase 1 always emits the monolith file regardless of `compile.mode`, so
 * threading this entrypoint through the build changes no output. Split
...
function renderPhase(phase, target, allModes, modesPerStep, reachable, emitTemplate) {
    ...
    return renderPhaseAsList(phase, visibleSteps, allModes, modesPerStep, target, emitTemplate);
}
...
function renderPhaseAsList(phase, visibleSteps, allModes, modesPerStep, target, emitTemplate) {
