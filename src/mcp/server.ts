...
server.registerTool(
  ...
  {
    description:
      "List all traced functions in your organization. Use this to discover which functions are instrumented with the Bitfab SDK.",
    inputSchema: {},
  },
...
server.registerTool(
  ...
  {
    description:
      "Search and filter traces for a traced function. Returns matching traces with IDs, status, timestamps, and output preview. Supports keyword search, date range, status filter, and regex matching. Use drillDown to refine previous results.",
    inputSchema: {
